...
///
/// An LCLPing instance allows the caller to initialize the ping test with either ICMP or HTTP method and read the result once the test finishes.
...
public struct LCLPing {
    ...
    /// - Parameters:
    ///     - options: the LCLPing options that defines the overall behavior of LCLPing. `options` is set with default values by default.
